...
-- (feature_flags table + is_feature_enabled function were removed; they
-- had 0 references in api/, cli/, or scripts/. Reintroduce with a real
-- client when feature toggles become a v0.2 requirement.)
